    ...
    view.innerHTML = `
      ...
      <div class="card-box mg-apply">
        ...
        <ul class="mg-list">
          ...
          <li><b>数字はシンボル(形)に変える</b> … 覚えにくい数字は、形の似たモノに置き換えて"絵"にします(例: 1=ろうそく🕯 / 2=白鳥🦢 / 3=耳👂 / 4=ヨット⛵ / 5=フック / 8=雪だるま⛄ / 0=ボール⚽)。「常時5人以上」なら壁にフックが5本、「14日以内」ならカレンダーに白鳥(2)…のように、数字をモノの絵にして場所に置くと、人数・日数・率が混同しにくくなります。</li>
