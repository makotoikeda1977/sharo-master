  ...
  function renderInfo() {
    ...
    view.innerHTML = `
      <section class="info-page">
        ...
        <div class="card-box info-card">
          <h3>🟥 赤シートの使い方</h3>
          <p>横断比較表は、最初は<b>答えが見えている</b>状態です。表の上にある「<b>⬜️ 赤シート OFF</b>」ボタンを押すと「<b>🟥 赤シート ON</b>」に変わり、覚えるべき答えが赤く隠れます。</p>
          <ol class="info-steps">
            <li><b>赤シートをON</b>にして、答えを隠す</li>
            <li>隠れた赤いマスを見て、<b>まず自分で答えを思い出す</b></li>
            <li>その赤いマスを<b>タップ</b>すると、答えだけが表示される（もう一度タップで再び隠れます）</li>
            <li>ボタンをもう一度押せば、<b>すべての答えが見える</b>状態に戻ります</li>
          </ol>
          <p class="muted info-small">ポイント：見て覚えるのではなく、<b>隠れた状態で思い出してからタップ</b>して確認するのがいちばん効きます（アクティブリコール）。各テーマ画面の「比較表を開く」からも同じ赤シートが使えます。</p>
        </div>
